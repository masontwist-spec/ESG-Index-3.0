    ...
    return `<tr>
      ...
      <td>
        <div class="company-name">
          <img src="assets/logos/${d.Ticker.toLowerCase()}.png" alt="${d.Company} logo" class="company-logo" onerror="this.style.display='none'">
      ...
      <td>${metricMarkup(d.Environment_Score)}</td>
      <td>${metricMarkup(d.Social_Score)}</td>
      <td>${metricMarkup(d.ESG_Score, true)}</td>
