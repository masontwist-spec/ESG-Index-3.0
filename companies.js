...
function renderTable() {
  ...
  document.getElementById('tableBody').innerHTML = rows.map(d => {
    ...
    return `<tr>
      ...
      <td><div class="score-value">${pct(d.Environment_Score)}</div></td>
      <td><div class="score-value">${pct(d.Social_Score)}</div></td>
      <td><div class="score-value" style="color:${color}">${pct(d.ESG_Score)}</div></td>
